...
def build_dcs():
    ...
    return {
        "us-west": DataCenter("us-west", gpu_type=H100_PCIe, total_gpus=16,
                              freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                              default_freq=1.0, power_gating=True),
        "us-east": DataCenter("us-east", gpu_type=A100_PCIe, total_gpus=32,
                              freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                              default_freq=1.0, power_gating=True),
        "eu-west": DataCenter("eu-west", gpu_type=L40S, total_gpus=256,
                              freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                              default_freq=1.0, power_gating=True),
        "eu-central": DataCenter("eu-central", gpu_type=H100_SXM, total_gpus=16,
                                 freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                                 default_freq=1.0, power_gating=True),
        "ap-southeast": DataCenter("ap-southeast", gpu_type=L4, total_gpus=128,
                                   freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                                   default_freq=1.0, power_gating=True),
        "ap-northeast": DataCenter("ap-northeast", gpu_type=H200_PCIe, total_gpus=16,
                                   freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                                   default_freq=1.0, power_gating=True),
        "sa-east": DataCenter("sa-east", gpu_type=A30, total_gpus=512,
                              freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                              default_freq=1.0, power_gating=True),
        "me-central": DataCenter("me-central", gpu_type=A10, total_gpus=512,
                                 freq_levels=[0.3,0.4,0.5,0.6,0.7,0.8,0.9,1.0],
                                 default_freq=1.0, power_gating=True),
    }
